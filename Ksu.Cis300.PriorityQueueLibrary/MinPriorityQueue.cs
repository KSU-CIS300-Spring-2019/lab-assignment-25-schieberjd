...
{
    /// <summary>
    /// Controls and mantains a MinPriorityQueue.
    /// </summary>
    /// <typeparam name="TPriority">The priority of a value.</typeparam>
    /// <typeparam name="TValue">The value of a value.</typeparam>
    public class MinPriorityQueue<TPriority, TValue> where TPriority : IComparable<TPriority>
    {
        ...
        /// <summary>
        /// Removes the element with the minimum priority from the tree.
        /// </summary>
